...
const AboutPage = () => {
  ...
  whileInView={{ y:0}} transition={{ duration:1}} className=" text-center text-[6vw] lg:text-[4vw] font-semibold leading-[8vw] lg:leading-[6vw] ">
  ...
  whileInView={{ x:0}} transition={{ duration:1}} className="flex flex-col gap-4 sm:gap-6 justify-center items-center">
  ...
  whileInView={{ opacity: 1 }} transition={{duration:2}} src="/assets/group.webp" width={400} height={400} alt="group" className="w-full lg:w-[35vw] rounded-xl" />
          </div>
        </div>
        ...
        <div className="pt-16 sm:pt-28 m-auto px-[6vw]">
          ...
          <div className="flex justify-center flex-wrap-reverse gap-6 sm:gap-8 lg:gap-14 text-center">
            <div className="">
              <motion.img initial={{ opacity: 0 }}
  whileInView={{ opacity: 1 }} transition={{duration:2}} src={ourstory} width={400} height={400} className="w-full lg:w-[35vw] rounded-xl" />
            </div>
            <motion.div initial={{ x: -200 }}
  whileInView={{ x:0}} transition={{ duration:1}} className="flex flex-col justify-center items-center">
        ...
        <div id='about-us' style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <motion.h5 initial={{ x: -200 }}
  whileInView={{ x:0}} transition={{ duration:1}} className="font-semibold text-center text-xl pb-2 lg:pb-6 text-green-500 mt-24 sm:mt-32 sm:text-[2rem]">Our Features</motion.h5>
          <div className='about-us-block lg:px-16'>
            <motion.div initial={{ y: 200 }}
  whileInView={{ y:0}} transition={{ duration:1}} className='about-us-community' onMouseOver={() => setNurseHovered(true)} onMouseLeave={() => setNurseHovered(false)}>
            ...
            <motion.div initial={{ y: 200 }}
  whileInView={{ y:0}} transition={{ duration:1}} className='about-us-product' onMouseOver={() => setCareerHovered(true)} onMouseLeave={() => setCareerHovered(false)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div  className='about-us-block lg:px-16'>
            <motion.div initial={{ y: 200 }}
  whileInView={{ y:0}} transition={{ duration:1}} className='about-us-location' onMouseOver={() => setPlaceHovered(true)} onMouseLeave={() => setPlaceHovered(false)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <motion.div initial={{ y: 200 }}
  whileInView={{ y:0}} transition={{ duration:1}} className='about-us-event' onMouseOver={() => setSupport(true)} onMouseLeave={() => setSupport(false)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
